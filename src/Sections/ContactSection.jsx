    ...
    <section className="py-16 bg-gray-50">
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
          ...
          {/* Contact Information */}
          <div
            className="bg-gradient-to-br from-purple-500 to-pink-500 text-white rounded-lg shadow-md p-8"
            data-aos="fade-left"
          >
            ...
            <div className="space-y-6">
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-white/90 mt-1">victormoses2b@gmail.com</p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-white/90 mt-1">+2349138691147</p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-white/90 mt-1">
                    123 Digital Avenue, Tech , Lagos Mainland
                  </p>
                </div>
              </div>
            </div>
